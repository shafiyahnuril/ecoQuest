# ecoQuest
Aplikasi gamifikasi aksi iklim: Platform gamifikasi berbasis poin untuk mendorong partisipasi aktif dalam aksi iklim sehari-hari.
...
![Class Diagram EcoQuest](docs/class-diagram/classDiagram.png) 

## Entity Relationship Diagram (ERD)

![ERD EcoQuest](docs/erd/erd_ecoQuest.png) 